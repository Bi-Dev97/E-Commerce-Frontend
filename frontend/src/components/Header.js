          ...
          <div className="row">
            ...
            <div className="col-6">
              <p className="text-end text-white mb-0">
                Hotline:{" "}
                <a className="text-white" href="tel:+228 70521112">
                  +228 70521112
                </a>
              </p>
            </div>
      ...
      <header className="header-upper py-3">
        <div className="container-xxl">
          <div className="row align-items-center ">
            <div className="col-2 ">
              <h4>
                <Link className="text-white ">Bi_Dev</Link>
              </h4>
            </div>
            <div className="col-5">
            ...
            <div className="col-5">
              <div className="header-upper-links d-flex align-items-center justify-content-between">
                ...
                <div >
                  <Link
                    to="/wishlist"
                    className="d-flex align-items-center love-logo  gap-10 text-white"
                  >
                    <img src={wishlist} alt="wishlist" className="love-img" />
                    <p className="mb-0">
                ...
                <div>
                  ...
                  >
                    ...
                    <div className="d-flex flex-column gap-10">
                      ...
                      <p className="mb-0">
                        ${" "}
                        {cartState?.length > 0 && total ? total.toFixed(2) : 0}
                      </p>
                    </div>
                  </Link>
                </div>
